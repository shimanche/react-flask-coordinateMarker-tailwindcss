...
def draw_and_save(image_path, cor):
    ...
    for point in cor:
        x, y = point
        cv2.rectangle(image, (x, y), (x + 30, y + 30), color=(0, 255, 0), thickness=1)
        # cv2.circle(image, point, radius=5, color=(0,255,0),thickness=-1 )
    
    save_path =  './static/image_with_markers.jpg'
    # 画像を保存する
